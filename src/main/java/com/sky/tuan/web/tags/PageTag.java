...
public class PageTag extends TagSupport{
	...
	public int doStartTag() throws JspException {
		...
		if(this.recordCount != 0&&this.recordCount>this.pageSize){
			...
			if(this.pageNo>1){
				sb.append("<li><a href='"+this.url+"page="+(this.pageNo-1)+"'>&laquo;</a></li>");
			}
			else
			{
			...
			if (this.pageNo != pageCount){
				sb.append("<li><a href='"+this.url+"page="+(this.pageNo+1)+"'>&raquo;</a></li>");
			}
			else
				sb.append("<li class='disabled'><span>&raquo;</span></li>");
		}
		if(anchor!=null){
			sb.append("<script type='text/javascript'>$('.pagination a').each(function(){var href=$(this).attr('href');$(this).attr('href',href+'"+anchor+"')});</script>");
		}
		sb.append("</ul>");
		try {
